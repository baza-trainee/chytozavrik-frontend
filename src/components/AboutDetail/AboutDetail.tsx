        ...
        <div className={styles.item}>
          ...
          <div className={styles.info}>
            ...
            <Typography variant="body" component="p" className={styles.text}>
              ...
              питання вікторини, обговорюючи прочитане. Це не тільки сприяє близькості в сім&apos;ї
              а й підтримує інтерес до книг.
            </Typography>
          </div>
        </div>
        <div className={styles.item}>
          ...
          <div className={styles.info}>
            ...
            <Typography variant="body" component="p" className={styles.text}>
              ...
              батькам відстежувати прогрес у читанні та переконуватися в тому, що їхня дитина
              отримує користь від використання додатку
            </Typography>
          </div>
        </div>
      </Container>

...
const passworsRegex = /^(?=.*[0-9])(?=.*[a-zA-Z])[A-Za-z\d$@$!%*?&.].{6,30}$/;
...
export const validation = {
  ...
  password: yup
    ...
    .max(30, ({ max }) => `Пароль має бути не більше ніж ${max} characters.`)
    .matches(passworsRegex, 'Пароль повинен містити 1 букву та 1 цифру.')
